...
pacman -S grub efibootmgr os-prober dosfstools ntfs-3g networkmanager network-manager-applet dialog wpa_supplicant base-devel linux-lts-headers linux-lts avahi xdg-user-dirs xdg-utils gvfs gvfs-smb nfs-utils inetutils dnsutils bluez bluez-utils cups hplip alsa-utils pipewire pipewire-alsa pipewire-pulse wireplumber bash-completion openssh rsync reflector acpi acpid acpi_call-lts tlp virt-manager qemu qemu-arch-extra edk2-ovmf bridge-utils vde2 openbsd-netcat iptables-nft ipset firewalld sof-firmware nss-mdns terminus-font nvidia-lts nvidia-utils pavucontrol btop net-tools docker docker-compose jq
